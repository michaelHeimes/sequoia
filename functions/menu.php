...
function joints_ad_tax_nav() {
	wp_nav_menu(array(
		...
		'menu_class'		=> 'medium-horizontal menu',	// Adding custom nav class
		'items_wrap'		=> '<ul id="%1$s" class="%2$s articles-grid grid-x grid-padding-x align-center" data-responsive-menu="accordion medium-dropdown">%3$s</ul>',
		'theme_location'	=> 'ad-tax-nav',			// Where it's located in the theme
		'list_item_class'   => 'cell shrink',
		'link_class'        => 'button outline',
		'depth'				=> 5,							// Limit the depth of the nav
		'fallback_cb'		=> false,						// Fallback function (see below)
		'walker'			=> new Topbar_Menu_Walker()
	));
